...
# 文件夹路径
folder_path = 'D:\\opencv-python\\sobel_tiff'
...
for group in grouped_files:
    ...
    split_circle.draw_pixel_at_circle_center(Bimg,'blue',picnum)
    split_circle.generate_json_file('blue')

    split_circle.draw_pixel_at_circle_center(Gimg,'green',picnum)
